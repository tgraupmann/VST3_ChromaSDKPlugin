...
#define stringOriginalFilename	"VST3_ChromaSDKPlugin.vst3"
#if SMTG_PLATFORM_64
#define stringFileDescription	"VST3_ChromaSDKPlugin VST3 (64Bit)"
#else
#define stringFileDescription	"VST3_ChromaSDKPlugin VST3"
#endif
#define stringCompanyName		"My Plug-in Company\0"
#define stringLegalCopyright	"Copyright(c) 2021 My Plug-in Company."
